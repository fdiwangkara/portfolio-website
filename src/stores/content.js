...
const defaultData = {
  hero: {
    name: "FILEMON DIWANGKARA",
    tagline: "Junior Developer & College Student",
    socials: [
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "A real-time analytics dashboard that visualizes complex data sets with interactive charts, filterable tables, and automated report generation.",
      duration: "4 months",
  ...
  education: [
    ...
    },
    {
      ...
      period: "2019 — 2020",
      description:
        "Intensive 6-month program covering modern web technologies, agile methodologies, and real-world project development.",
    },
    {
      id: "edu-3",
      ...
      period: "2017 — 2020",
      description:
        "Academic excellence with focus on mathematics and physics. Active in programming club and science olympiad.",
    },
  ],
  ...
  experiences: [
    {
      ...
      description:
        "Leading frontend development for enterprise applications, implementing modern UI patterns and optimizing performance.",
    },
    {
      id: "exp-2",
      company: "StartupHub",
      ...
      description:
        "Developed full-stack features for SaaS products, from database design to frontend implementation.",
    },
    {
      id: "exp-3",
      ...
      description:
        "Built responsive websites for agency clients, focusing on animation and interactive user experiences.",
    },
  ],
  ...
  contact: {
    ...
    email: "fdiwangkara2412@gmail.com",
  },
};
