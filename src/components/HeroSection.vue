    ...
    <div class="hero-inner section-container">
      ...
      <div class="hero-columns" ref="columnsRef">
        ...
        <div class="hero-col hero-col--center">
          <p class="hero-lead">
            A creative developer building digital experiences at the intersection of design and technology—crafting interfaces that inform, delight, and endure.
          </p>
        </div>
        ...
        <div class="hero-col hero-col--right">
          <div class="hero-socials">
            <a
              ...
              class="social-link"
            >
              <svg class="social-icon" viewBox="0 0 24 24" v-html="getSocialIcon(social.icon)"></svg>
            </a>
          </div>
...
onMounted(async () => {
  ...
  setTimeout(() => {
    ...
    gsap.set([topRuleRef.value, midRuleRef.value, btmRuleRef.value], { scaleX: 0, transformOrigin: 'center' })
    ...
    tl.to(topRuleRef.value, { scaleX: 1, duration: 0.7, ease: 'power2.inOut' })
      ...
      .to(midRuleRef.value, { scaleX: 1, duration: 0.5, ease: 'power2.inOut' }, '-=0.2')
      .to(columnsRef.value, { opacity: 1, y: 0, duration: 0.5 }, '-=0.1')
      .to(btmRuleRef.value, { scaleX: 1, duration: 0.5, ease: 'power2.inOut' }, '-=0.2')
  }, 200)
})
</script>
